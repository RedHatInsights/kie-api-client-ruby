...
# Unit tests for KieClient::ErrorInfoInstanceList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorInfoInstanceList' do
  before do
    # run before each test
    @instance = KieClient::ErrorInfoInstanceList.new
  end
  ...
  describe 'test an instance of ErrorInfoInstanceList' do
    it 'should create an instance of ErrorInfoInstanceList' do
      expect(@instance).to be_instance_of(KieClient::ErrorInfoInstanceList)
    end
  end
