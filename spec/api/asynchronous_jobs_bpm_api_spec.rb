...
# Unit tests for KieClient::AsynchronousJobsBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AsynchronousJobsBPMApi' do
  before do
    # run before each test
    @instance = KieClient::AsynchronousJobsBPMApi.new
  end
  ...
  describe 'test an instance of AsynchronousJobsBPMApi' do
    it 'should create an instance of AsynchronousJobsBPMApi' do
      expect(@instance).to be_instance_of(KieClient::AsynchronousJobsBPMApi)
    end
  end
