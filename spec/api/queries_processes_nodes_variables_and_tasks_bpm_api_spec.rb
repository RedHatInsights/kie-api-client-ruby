...
# Unit tests for KieClient::QueriesProcessesNodesVariablesAndTasksBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueriesProcessesNodesVariablesAndTasksBPMApi' do
  before do
    # run before each test
    @instance = KieClient::QueriesProcessesNodesVariablesAndTasksBPMApi.new
  end
  ...
  describe 'test an instance of QueriesProcessesNodesVariablesAndTasksBPMApi' do
    it 'should create an instance of QueriesProcessesNodesVariablesAndTasksBPMApi' do
      expect(@instance).to be_instance_of(KieClient::QueriesProcessesNodesVariablesAndTasksBPMApi)
    end
  end
