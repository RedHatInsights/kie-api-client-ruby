...
# Unit tests for KieClient::UserTasksAdministrationBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserTasksAdministrationBPMApi' do
  before do
    # run before each test
    @instance = KieClient::UserTasksAdministrationBPMApi.new
  end
  ...
  describe 'test an instance of UserTasksAdministrationBPMApi' do
    it 'should create an instance of UserTasksAdministrationBPMApi' do
      expect(@instance).to be_instance_of(KieClient::UserTasksAdministrationBPMApi)
    end
  end
