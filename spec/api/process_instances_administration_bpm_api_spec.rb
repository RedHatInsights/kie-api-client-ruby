...
# Unit tests for KieClient::ProcessInstancesAdministrationBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProcessInstancesAdministrationBPMApi' do
  before do
    # run before each test
    @instance = KieClient::ProcessInstancesAdministrationBPMApi.new
  end
  ...
  describe 'test an instance of ProcessInstancesAdministrationBPMApi' do
    it 'should create an instance of ProcessInstancesAdministrationBPMApi' do
      expect(@instance).to be_instance_of(KieClient::ProcessInstancesAdministrationBPMApi)
    end
  end

  # unit tests for acknowledge_error
  ...
  # @return [nil]
  describe 'acknowledge_error test' do
    it "should work" do
  ...
  # unit tests for get_execution_error_by_id
  ...
  describe 'get_execution_error_by_id test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
