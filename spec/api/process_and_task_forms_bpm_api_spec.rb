...
# Unit tests for KieClient::ProcessAndTaskFormsBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProcessAndTaskFormsBPMApi' do
  before do
    # run before each test
    @instance = KieClient::ProcessAndTaskFormsBPMApi.new
  end
  ...
  describe 'test an instance of ProcessAndTaskFormsBPMApi' do
    it 'should create an instance of ProcessAndTaskFormsBPMApi' do
      expect(@instance).to be_instance_of(KieClient::ProcessAndTaskFormsBPMApi)
    end
  end
