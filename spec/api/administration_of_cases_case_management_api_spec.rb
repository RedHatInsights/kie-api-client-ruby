...
# Unit tests for KieClient::AdministrationOfCasesCaseManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdministrationOfCasesCaseManagementApi' do
  before do
    # run before each test
    @instance = KieClient::AdministrationOfCasesCaseManagementApi.new
  end
  ...
  describe 'test an instance of AdministrationOfCasesCaseManagementApi' do
    it 'should create an instance of AdministrationOfCasesCaseManagementApi' do
      expect(@instance).to be_instance_of(KieClient::AdministrationOfCasesCaseManagementApi)
    end
  end
