...
# Unit tests for KieClient::ProcessInstancesBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProcessInstancesBPMApi' do
  before do
    # run before each test
    @instance = KieClient::ProcessInstancesBPMApi.new
  end
  ...
  describe 'test an instance of ProcessInstancesBPMApi' do
    it 'should create an instance of ProcessInstancesBPMApi' do
      expect(@instance).to be_instance_of(KieClient::ProcessInstancesBPMApi)
    end
  end
