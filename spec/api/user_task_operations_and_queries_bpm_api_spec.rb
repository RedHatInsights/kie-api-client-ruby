...
# Unit tests for KieClient::UserTaskOperationsAndQueriesBPMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserTaskOperationsAndQueriesBPMApi' do
  before do
    # run before each test
    @instance = KieClient::UserTaskOperationsAndQueriesBPMApi.new
  end
  ...
  describe 'test an instance of UserTaskOperationsAndQueriesBPMApi' do
    it 'should create an instance of UserTaskOperationsAndQueriesBPMApi' do
      expect(@instance).to be_instance_of(KieClient::UserTaskOperationsAndQueriesBPMApi)
    end
  end
