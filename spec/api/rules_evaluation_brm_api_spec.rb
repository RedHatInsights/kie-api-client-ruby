...
# Unit tests for KieClient::RulesEvaluationBRMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RulesEvaluationBRMApi' do
  before do
    # run before each test
    @instance = KieClient::RulesEvaluationBRMApi.new
  end
  ...
  describe 'test an instance of RulesEvaluationBRMApi' do
    it 'should create an instance of RulesEvaluationBRMApi' do
      expect(@instance).to be_instance_of(KieClient::RulesEvaluationBRMApi)
    end
  end
