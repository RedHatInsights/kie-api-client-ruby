...
# Unit tests for KieClient::QueriesCaseDefinitionsAndInstancesCaseManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueriesCaseDefinitionsAndInstancesCaseManagementApi' do
  before do
    # run before each test
    @instance = KieClient::QueriesCaseDefinitionsAndInstancesCaseManagementApi.new
  end
  ...
  describe 'test an instance of QueriesCaseDefinitionsAndInstancesCaseManagementApi' do
    it 'should create an instance of QueriesCaseDefinitionsAndInstancesCaseManagementApi' do
      expect(@instance).to be_instance_of(KieClient::QueriesCaseDefinitionsAndInstancesCaseManagementApi)
    end
  end
