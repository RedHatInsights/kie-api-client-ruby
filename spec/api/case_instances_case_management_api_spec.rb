...
# Unit tests for KieClient::CaseInstancesCaseManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CaseInstancesCaseManagementApi' do
  before do
    # run before each test
    @instance = KieClient::CaseInstancesCaseManagementApi.new
  end
  ...
  describe 'test an instance of CaseInstancesCaseManagementApi' do
    it 'should create an instance of CaseInstancesCaseManagementApi' do
      expect(@instance).to be_instance_of(KieClient::CaseInstancesCaseManagementApi)
    end
  end
  ...
  # unit tests for add_dynamic_process_to_case_0
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'add_dynamic_process_to_case_0 test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for add_dynamic_task_to_case_0
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'add_dynamic_task_to_case_0 test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
