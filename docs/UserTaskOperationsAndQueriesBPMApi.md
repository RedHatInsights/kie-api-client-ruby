# KieClient::UserTaskOperationsAndQueriesBPMApi
...
[**add_comment**](UserTaskOperationsAndQueriesBPMApi.md#add_comment) | **POST** /server/containers/{id}/tasks/{tInstanceId}/comments | Adds comment to task with given id that belongs to given container
...
[**get_task_events**](UserTaskOperationsAndQueriesBPMApi.md#get_task_events) | **GET** /server/containers/{id}/tasks/{tInstanceId}/events | Retrieves task events for given task id and applies pagination
...
api_instance = KieClient::UserTaskOperationsAndQueriesBPMApi.new
...
# **add_comment**
> Integer add_comment(id, t_instance_id, body)
...
begin
  #Adds comment to task with given id that belongs to given container
  result = api_instance.add_comment(id, t_instance_id, body)
  p result
rescue KieClient::ApiError => e
  puts "Exception when calling UserTaskOperationsAndQueriesBPMApi->add_comment: #{e}"
end
```
...
# **get_task_events**
> TaskEventInstanceList get_task_events(id, t_instance_id, opts)
...
begin
  #Retrieves task events for given task id and applies pagination
  result = api_instance.get_task_events(id, t_instance_id, opts)
  p result
rescue KieClient::ApiError => e
  puts "Exception when calling UserTaskOperationsAndQueriesBPMApi->get_task_events: #{e}"
end
```
