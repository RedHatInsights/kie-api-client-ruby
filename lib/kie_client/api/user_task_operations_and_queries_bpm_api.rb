...
module KieClient
  class UserTaskOperationsAndQueriesBPMApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Integer]
    def add_comment(id, t_instance_id, body, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Integer, Fixnum, Hash)>] Integer data, response status code and response headers
    def add_comment_with_http_info(id, t_instance_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserTaskOperationsAndQueriesBPMApi.add_comment ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UserTaskOperationsAndQueriesBPMApi.add_comment"
      end
      # verify the required parameter 't_instance_id' is set
      if @api_client.config.client_side_validation && t_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 't_instance_id' when calling UserTaskOperationsAndQueriesBPMApi.add_comment"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling UserTaskOperationsAndQueriesBPMApi.add_comment"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Integer')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserTaskOperationsAndQueriesBPMApi#add_comment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_task_events(id, t_instance_id, opts = {})
      data, _status_code, _headers = get_task_events_with_http_info(id, t_instance_id, opts)
      return data
    end
    ...
    def get_task_events_with_http_info(id, t_instance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserTaskOperationsAndQueriesBPMApi.get_task_events ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UserTaskOperationsAndQueriesBPMApi.get_task_events"
      end
      # verify the required parameter 't_instance_id' is set
      if @api_client.config.client_side_validation && t_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 't_instance_id' when calling UserTaskOperationsAndQueriesBPMApi.get_task_events"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserTaskOperationsAndQueriesBPMApi#get_task_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
