...
module KieClient
  class UserTasksAdministrationBPMApi
    ...
    # @return [nil]
    def acknowledge_error(id, error_id, opts = {})
      acknowledge_error_with_http_info(id, error_id, opts)
      return nil
    end
    ...
    def acknowledge_error_with_http_info(id, error_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserTasksAdministrationBPMApi.acknowledge_error ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UserTasksAdministrationBPMApi.acknowledge_error"
      end
      # verify the required parameter 'error_id' is set
      if @api_client.config.client_side_validation && error_id.nil?
        fail ArgumentError, "Missing the required parameter 'error_id' when calling UserTasksAdministrationBPMApi.acknowledge_error"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserTasksAdministrationBPMApi#acknowledge_error\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def acknowledge_errors_with_http_info(id, error_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserTasksAdministrationBPMApi.acknowledge_errors ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UserTasksAdministrationBPMApi.acknowledge_errors"
      end
      # verify the required parameter 'error_id' is set
      if @api_client.config.client_side_validation && error_id.nil?
        fail ArgumentError, "Missing the required parameter 'error_id' when calling UserTasksAdministrationBPMApi.acknowledge_errors"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserTasksAdministrationBPMApi#acknowledge_errors\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_execution_error_by_id(id, error_id, opts = {})
      data, _status_code, _headers = get_execution_error_by_id_with_http_info(id, error_id, opts)
      return data
    end
    ...
    def get_execution_error_by_id_with_http_info(id, error_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserTasksAdministrationBPMApi.get_execution_error_by_id ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UserTasksAdministrationBPMApi.get_execution_error_by_id"
      end
      # verify the required parameter 'error_id' is set
      if @api_client.config.client_side_validation && error_id.nil?
        fail ArgumentError, "Missing the required parameter 'error_id' when calling UserTasksAdministrationBPMApi.get_execution_error_by_id"
      end
      # resource path
      local_var_path = "/server/admin/containers/{id}/tasks/errors/{errorId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'errorId' + '}', error_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserTasksAdministrationBPMApi#get_execution_error_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_execution_errors_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserTasksAdministrationBPMApi.get_execution_errors ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UserTasksAdministrationBPMApi.get_execution_errors"
      end
      # resource path
      local_var_path = "/server/admin/containers/{id}/tasks/errors".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserTasksAdministrationBPMApi#get_execution_errors\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
