...
module KieClient
  class ProcessInstancesBPMApi
    ...
    def get_process_instance_history(id, p_instance_id, opts = {})
      data, _status_code, _headers = get_process_instance_history_with_http_info(id, p_instance_id, opts)
      return data
    end
    ...
    def get_process_instance_history_with_http_info(id, p_instance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProcessInstancesBPMApi.get_process_instance_history ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProcessInstancesBPMApi.get_process_instance_history"
      end
      # verify the required parameter 'p_instance_id' is set
      if @api_client.config.client_side_validation && p_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'p_instance_id' when calling ProcessInstancesBPMApi.get_process_instance_history"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProcessInstancesBPMApi#get_process_instance_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_process_instances(id, p_instance_id, opts = {})
      data, _status_code, _headers = get_process_instances_with_http_info(id, p_instance_id, opts)
      return data
    end
    ...
    def get_process_instances_with_http_info(id, p_instance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProcessInstancesBPMApi.get_process_instances ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProcessInstancesBPMApi.get_process_instances"
      end
      # verify the required parameter 'p_instance_id' is set
      if @api_client.config.client_side_validation && p_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'p_instance_id' when calling ProcessInstancesBPMApi.get_process_instances"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProcessInstancesBPMApi#get_process_instances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
