...
module KieClient
  class CaseInstancesCaseManagementApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def add_dynamic_process_to_case(id, case_id, case_stage_id, p_id, body, opts = {})
      add_dynamic_process_to_case_with_http_info(id, case_id, case_stage_id, p_id, body, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def add_dynamic_process_to_case_with_http_info(id, case_id, case_stage_id, p_id, body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && case_stage_id.nil?
        fail ArgumentError, "Missing the required parameter 'case_stage_id' when calling CaseInstancesCaseManagementApi.add_dynamic_process_to_case"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def add_dynamic_process_to_case_0(id, case_id, p_id, body, opts = {})
      add_dynamic_process_to_case_0_with_http_info(id, case_id, p_id, body, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def add_dynamic_process_to_case_0_with_http_info(id, case_id, p_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CaseInstancesCaseManagementApi.add_dynamic_process_to_case_0 ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CaseInstancesCaseManagementApi.add_dynamic_process_to_case_0"
      end
      # verify the required parameter 'case_id' is set
      if @api_client.config.client_side_validation && case_id.nil?
        fail ArgumentError, "Missing the required parameter 'case_id' when calling CaseInstancesCaseManagementApi.add_dynamic_process_to_case_0"
      end
      # verify the required parameter 'p_id' is set
      if @api_client.config.client_side_validation && p_id.nil?
        fail ArgumentError, "Missing the required parameter 'p_id' when calling CaseInstancesCaseManagementApi.add_dynamic_process_to_case_0"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CaseInstancesCaseManagementApi.add_dynamic_process_to_case_0"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CaseInstancesCaseManagementApi#add_dynamic_process_to_case_0\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def add_dynamic_task_to_case(id, case_id, case_stage_id, body, opts = {})
      add_dynamic_task_to_case_with_http_info(id, case_id, case_stage_id, body, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def add_dynamic_task_to_case_with_http_info(id, case_id, case_stage_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'case_stage_id' is set
      if @api_client.config.client_side_validation && case_stage_id.nil?
        fail ArgumentError, "Missing the required parameter 'case_stage_id' when calling CaseInstancesCaseManagementApi.add_dynamic_task_to_case"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def add_dynamic_task_to_case_0(id, case_id, body, opts = {})
      add_dynamic_task_to_case_0_with_http_info(id, case_id, body, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def add_dynamic_task_to_case_0_with_http_info(id, case_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CaseInstancesCaseManagementApi.add_dynamic_task_to_case_0 ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CaseInstancesCaseManagementApi.add_dynamic_task_to_case_0"
      end
      # verify the required parameter 'case_id' is set
      if @api_client.config.client_side_validation && case_id.nil?
        fail ArgumentError, "Missing the required parameter 'case_id' when calling CaseInstancesCaseManagementApi.add_dynamic_task_to_case_0"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CaseInstancesCaseManagementApi.add_dynamic_task_to_case_0"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CaseInstancesCaseManagementApi#add_dynamic_task_to_case_0\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
