...
module KieClient
  class QueriesProcessesNodesVariablesAndTasksBPMApi
    ...
    def get_processes_by_deployment_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QueriesProcessesNodesVariablesAndTasksBPMApi.get_processes_by_deployment_id ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling QueriesProcessesNodesVariablesAndTasksBPMApi.get_processes_by_deployment_id"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QueriesProcessesNodesVariablesAndTasksBPMApi#get_processes_by_deployment_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_variable_history(p_instance_id, var_name, opts = {})
      data, _status_code, _headers = get_variable_history_with_http_info(p_instance_id, var_name, opts)
      return data
    end
    ...
    def get_variable_history_with_http_info(p_instance_id, var_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QueriesProcessesNodesVariablesAndTasksBPMApi.get_variable_history ..."
      end
      # verify the required parameter 'p_instance_id' is set
      if @api_client.config.client_side_validation && p_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'p_instance_id' when calling QueriesProcessesNodesVariablesAndTasksBPMApi.get_variable_history"
      end
      # verify the required parameter 'var_name' is set
      if @api_client.config.client_side_validation && var_name.nil?
        fail ArgumentError, "Missing the required parameter 'var_name' when calling QueriesProcessesNodesVariablesAndTasksBPMApi.get_variable_history"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QueriesProcessesNodesVariablesAndTasksBPMApi#get_variable_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [VariableInstanceList]
    def get_variables_current_state(p_instance_id, opts = {})
      data, _status_code, _headers = get_variables_current_state_with_http_info(p_instance_id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(VariableInstanceList, Fixnum, Hash)>] VariableInstanceList data, response status code and response headers
    def get_variables_current_state_with_http_info(p_instance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QueriesProcessesNodesVariablesAndTasksBPMApi.get_variables_current_state ..."
      end
      # verify the required parameter 'p_instance_id' is set
      if @api_client.config.client_side_validation && p_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'p_instance_id' when calling QueriesProcessesNodesVariablesAndTasksBPMApi.get_variables_current_state"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VariableInstanceList')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QueriesProcessesNodesVariablesAndTasksBPMApi#get_variables_current_state\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
