  ...
  class ProcessInstancesAdministrationBPMApi
    ...
    def acknowledge_error_with_http_info(id, error_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProcessInstancesAdministrationBPMApi.acknowledge_error ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProcessInstancesAdministrationBPMApi.acknowledge_error"
      end
      # verify the required parameter 'error_id' is set
      if @api_client.config.client_side_validation && error_id.nil?
        fail ArgumentError, "Missing the required parameter 'error_id' when calling ProcessInstancesAdministrationBPMApi.acknowledge_error"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProcessInstancesAdministrationBPMApi#acknowledge_error\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_execution_error_by_id_with_http_info(id, error_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProcessInstancesAdministrationBPMApi.get_execution_error_by_id ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProcessInstancesAdministrationBPMApi.get_execution_error_by_id"
      end
      # verify the required parameter 'error_id' is set
      if @api_client.config.client_side_validation && error_id.nil?
        fail ArgumentError, "Missing the required parameter 'error_id' when calling ProcessInstancesAdministrationBPMApi.get_execution_error_by_id"
      end
      # resource path
      local_var_path = "/server/admin/containers/{id}/processes/errors/{errorId}".sub('{' + 'id' + '}', id.to_s).sub('{' + 'errorId' + '}', error_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProcessInstancesAdministrationBPMApi#get_execution_error_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
