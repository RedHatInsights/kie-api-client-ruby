  ...
  class AdministrationOfCasesCaseManagementApi
    ...
    def get_case_instances_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AdministrationOfCasesCaseManagementApi.get_case_instances ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdministrationOfCasesCaseManagementApi#get_case_instances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
